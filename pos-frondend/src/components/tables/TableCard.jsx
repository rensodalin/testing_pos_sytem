...
const TableCard = ({ id, name, status, initials, seats }) => {
  ...
  return (
    <div
      ...
      key={id}
      className="w-full sm:w-[48%] md:w-[300px] bg-[#262626] hover:bg-[#2c2c2c] p-4 rounded-lg cursor-pointer transition-all duration-300 ease-in-out"
    >
      <div className="flex items-center justify-between px-1">
        ...
        <p
          ...
          } px-2 py-1 rounded-lg text-xs md:text-sm`}
        >
          {status}
        </p>
      </div>
      <div className="flex items-center justify-center mt-5 mb-8">
        <h1
          className="text-white rounded-full p-4 md:p-5 text-lg md:text-xl"
