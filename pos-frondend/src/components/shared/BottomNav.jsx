...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#202a3e] p-2 h-16 flex justify-around">
      ...
      <button onClick={() => navigate("/orders")} className="flex items-center justify-center text-[#ababab] w-[200px] rounded-[20px]">
        <MdOutlineReorder className="inline mr-2" size={20} /> <p>Orders</p>
      </button>

      <button onClick={() => navigate("/tables")} className="flex items-center justify-center text-[#ababab] w-[200px] rounded-[20px]">
        <MdTableBar className="inline mr-2" size={20} /> <p>Tables</p>
      </button>

      <button onClick={() => navigate("/more")} className="flex items-center justify-center text-[#ababab] w-[200px] rounded-[20px]">
      ...
      <Modal isOpen ={isModalOpen} onClose ={closeModal} title ="Create order" >
       ...
       <div>
        ...
        <div className="flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
          <input type="number" name=""  placeholder ="+855 " id="" 
          className="bg-transparent flex-1 text-white focus:outline-none" />
        </div>
       </div>
       <div>
