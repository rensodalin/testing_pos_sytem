...
//       onClick={handleClick}
//       key={id}
//       className="w-full sm:w-[240px] bg-[#262626] hover:bg-[#2c2c2c] p-3 rounded-lg cursor-pointer transition"
//     >
//       <div className="flex items-center justify-between mb-2">
//         <h1 className="text-[#f5f5f5] text-base font-semibold flex items-center">
//           Table <FaLongArrowAltRight className="text-[#ababab] ml-1" /> {name}
//         </h1>
//         <p
//           className={`${
//             status === "Booked"
...
//         <div
//           className="text-white rounded-full w-12 h-12 flex items-center justify-center text-sm"
